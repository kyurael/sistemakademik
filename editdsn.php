...
value="<?=$data['thnmasuk']?>" placeholder="yyyy" required>
<br>
<label for="">No. Telpon : </label>
<input type="text" name="nohp" id="nohp"
value="<?=$data['no_tlpn']?>" placeholder="08xxxxxxxxxx" required>
<br>
<label for="">Email : </label>
<input type="text" name="email" id="email"
value="<?=$data['email']?>" placeholder="namakamu@gmail.com" required>
<br><br>
