<?php
 ...
 $updatedsn="UPDATE tbl_dsn SET nama='$namadsn', alamat='$alamatdsn', tgllhir='$ttldsn', agama='$agama', walikls='$wlkls', thnmasuk='$thnmsk', no_tlpn='$nohp', email='$email' WHERE kd_dosen='$kode'";
